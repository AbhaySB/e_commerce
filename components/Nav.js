...
export default function Nav({show}) {
    ...
    const activeLink = inactiveLink + ' text-black bg-white rounded-l-lg border border-gray-300 '
    ...
    return (
        <aside className={(show ? "left-0" : "-left-full")+" top-0 text-gray-600 p-4 pr-2 fixed w-full bg-gray-100 h-full md:static md:w-auto transition-all"}>
            ...
            <nav className="flex flex-col gap-2">
                ...
                <Link href={'/order'} className={pathname.includes("/order") ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes("/order") ? activeIcon : inactiveIcon}>
